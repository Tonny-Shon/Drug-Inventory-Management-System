...
?>
			<div class="container">
			  ...
			  <div class="col-sm-12 col-md-5 col-lg-5">
				<div class="card" style="background-image: url('data/system_images/images/bgdimage6.jpg');">>
				  <div class="card-header">
					Register
				  </div>
				  <div><h2 style="text-align:center; color:black;">DRUG INVENTORY MANAGEMENT SYSTEM</h2></div>
				  <div><img src="data/system_images/images/bgdimage7.jpeg" alt="" width="100px" height="100px" style="border-radius: 50%; margin-left:150px;"></div>
				  <div class="card-body">
					<form action="">
