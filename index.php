...
?>
    ...
    <div class="container-fluid">
	  <div class="row">
		<div class="col-lg-2">
		<h1 class="my-4"></h1>
		<div><Img><img src="data/system_images/images/bgdimage2.jpeg" alt="" width="200px" height="200px"></Img></div>
			<div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
			  <a class="nav-link active" id="v-pills-item-tab" data-toggle="pill" href="#v-pills-item" role="tab" aria-controls="v-pills-item" aria-selected="true">Drug</a>
		 ...
		 <div class="col-lg-10" style="background-image: url('data/system_images/images/bgdimage6.jpg');">
				  ...
				  <div class="card-body">
					...
					<div class="tab-content">
						...
						<div id="itemImageTab" class="container-fluid tab-pane fade">
							...
							<p>You can upload an image for a particular drug using this section.</p> 
							<p>Please make sure the drug is already added to database before uploading the image.</p>
							<br>							
